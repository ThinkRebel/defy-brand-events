...
/** WhatsApp (mobile) and ceeme.be, the GEO tool we built — both live in the footer on every page. */
const WHATSAPP = { display: "0478 13 13 26", href: "https://wa.me/32478131326" };
  ...
  return (
    <footer className={styles.footer}>
      ...
      <div className={styles.meta}>
        ...
        <a className={styles.wa} href={WHATSAPP.href} target="_blank" rel="noopener" data-cursor>
