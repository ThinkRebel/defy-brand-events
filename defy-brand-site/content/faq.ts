...
export const FAQ: Record<string, FaqSet> = {
  home: {
    nl: [
      ...
      { q: "Hoe start een samenwerking?", a: "Je vertelt ons wat er in je hoofd zit via het contactformulier of marketing@defyandbrandevents.be. Binnen twee werkdagen hoor je van ons team, niet van een autoresponder. Daarna plannen we een gesprek en krijg je een concreet voorstel." },
    ...
    fr: [
      ...
      { q: "Comment démarre une collaboration ?", a: "Vous nous racontez ce que vous avez en tête via le formulaire ou marketing@defyandbrandevents.be. Sous deux jours ouvrables, notre équipe vous répond — pas un répondeur automatique. Ensuite : un entretien et une proposition concrète." },
    ...
    en: [
      ...
      { q: "How does a collaboration start?", a: "Tell us what's on your mind through the contact form or marketing@defyandbrandevents.be. Within two working days you hear from our team, not an autoresponder. Then we talk, and you get a concrete proposal." },
  ...
  contact: {
    nl: [
      { q: "Hoe snel krijg ik antwoord?", a: "Binnen twee werkdagen, van ons team. Dringend? Bel 059 70 99 69." },
    ...
    fr: [
      { q: "En combien de temps recevrai-je une réponse ?", a: "Sous deux jours ouvrables, de notre équipe. Urgent ? Appelez le 059 70 99 69." },
    ...
    en: [
      { q: "How fast do I get a reply?", a: "Within two working days, from our team. Urgent? Call +32 59 70 99 69." },
